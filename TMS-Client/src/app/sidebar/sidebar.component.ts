...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/registration',  title: 'Registration List',      icon:'nc-pin-3',      class: '' },
    { path: '/feedback',      title: 'Feedback',          icon:'nc-bell-55',    class: '', submenu: [
        { path: '/employee-feedback', title: 'Employee Feedback', icon:'', class: '' },
        { path: '/trainer-feedback',  title: 'Training Feedback', icon: '', class: '' },
    ]},
