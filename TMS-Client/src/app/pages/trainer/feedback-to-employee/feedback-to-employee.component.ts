 ...
 schedule_Id:string;
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe((params) => {
      ...
      // Update the currentEmpId and currentScheduleId in the DataService
      this.dataService.changeEmpId(this.emp_Id);
      this.dataService.changeScheduleId(this.schedule_Id);
    });
