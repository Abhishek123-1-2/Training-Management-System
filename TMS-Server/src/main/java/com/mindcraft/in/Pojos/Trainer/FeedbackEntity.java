...
public class FeedbackEntity {
    ...
    @Column(name = "feedback_parameters_11")
    private int effectiveness;

    @Column(name = "feedback_parameters_12")
    private int content;

    @Column(name = "feedback_parameters_13")
    private int methodology;

    @Column(name = "feedback_parameters_14")
    private int organization;

    @Column(name = "feedback_parameters_15")
    private int trainer_rating;
    ...
    public FeedbackEntity(Long attendanceId, Long fid, Long scheduleId, Long empId, int technicalSkills,
            int graspingPower, int proActiveness, int interestQuality, int leadershipQuality, int problemSolvingAbility,
            int smartnessRate, int spokenEnglishRate, String assignmentStatus, String performanceStatus,
            String commentsFromTrainer, int effectiveness, int content, int methodology, int organization,
            int trainer_rating, String commentsFromEmployee, String feedback_type, char active_yn, String created_by,
            Timestamp created_on, String updated_by, Timestamp updated_on, double totalRating) {
        this.attendanceId = attendanceId;
        this.fid = fid;
        this.scheduleId = scheduleId;
        this.empId = empId;
